# :earth_africa: @hishprorg/commodi-distinctio-alias
...
- [**Get started**](#get-started) - how to add `@hishprorg/commodi-distinctio-alias` to your project
...
---
### Is `@hishprorg/commodi-distinctio-alias` supported by `i18n-ally`?
